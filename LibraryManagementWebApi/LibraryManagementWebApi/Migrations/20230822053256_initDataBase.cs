    ...
    public partial class initDataBase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookInPublishers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookInPublishers_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowingHistorys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BorrowingHistorys_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowingHistorys_Borrows_BorrowId",
                        column: x => x.BorrowId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookInPublishers_BookId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowingHistorys_BookId",
                table: "BorrowingHistorys",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BorrowingHistorys_BorrowId",
                table: "BorrowingHistorys",
                column: "BorrowId");
        }
